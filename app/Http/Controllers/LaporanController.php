...
class LaporanController extends Controller
{
    ...
    public function cetak($id){
        ...
        ->select('b.id_booking as id_booking', 'cr.name_charge_vehicles as name_charge', 'cr.price_charge_vehicles as price_charge', 'pr.id_payment_rent as id_payment', 'v.nopol as nopol', 'v.tahun_pembuatan as tahun_pembuatan', 'ec.id_employes as id_employes', 'c.name_customer as name_customer', 'vv.vehicles_type as type_unit', 'b.date_start as date_start', 'b.date_finish as date_finish', 's.name_sales as name_sales',
        'ec.name_employes as name_employess', 'pr.total_payment as price_user', 'b.dp_sales as dp_sales', 'dp.description as description')
        ->groupBy('id_booking', 'type_unit', 'name_charge', 'price_charge', 'id_payment', 'id_employes', 'nopol', 'tahun_pembuatan', 'name_customer', 'date_start', 'date_finish', 'name_sales', 'name_employess', 'price_user', 'dp_sales', 'description')
